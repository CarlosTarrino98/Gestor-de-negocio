...
class Factura(models.Model):
    ...
    telefono_empresa = models.CharField(max_length=20, default="628932774", editable=False)
    email_empresa = models.EmailField(default="agustintarrino@hotmail.com", editable=False)
    ...
    nombre_emisor = models.CharField(max_length=100, default="Agustin Tarriño Castaño", editable=False)
    direccion_emisor = models.CharField(max_length=255, default="Salvador Dali, 15, local 6-7, 2884, Mejorada del Campo, España", editable=False)
    cif_nif_emisor = models.CharField(max_length=20, default="08983692F", editable=False)
